...
(
    ...
    CONSTRAINT FOREIGN KEY fk_note_plante (id_plante) REFERENCES plante(id_plante) ON DELETE CASCADE
);
...
(
    ...
    CONSTRAINT FOREIGN KEY fk_note_zone (id_zone) REFERENCES zone(id_zone) ON DELETE CASCADE,
);
...
(
    ...
    CONSTRAIN FOREIGN KEY fk_note_graine (id_graine) REFERENCES graine(id_graine) ON DELETE CASCADE,
);
